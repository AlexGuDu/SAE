...
<head>
    ...
    <link rel="stylesheet" href="css/header-sae.css">
</head>
        ...
        <div class="container" id="logo-sae">
            <div class="row top-buffer align-items-center justify-content-center">
                <div class="col-3 col-md-2">
                    <img src="imagenes/logo-sae-cimarron.png" class="img-fluid">
                </div>
                <div class="col-7 col-md-9">
                    <p class="h1 font-weight-light text-center ">Sistema de Actividades Extracurriculares</p>
                    <img src="imagenes/linea-verde.png" class="img-fluid">
                </div>
                <div class="col-2 col-md-1 align-self-start">
                    <img src="imagenes/interrogacion.png" class="img-fluid" id="interrogacion">
                </div>
            </div>
        </div>
        <!-- FIN DE LOGO -->
