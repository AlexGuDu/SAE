...
function ConsultaDeRegistros(){
  ...
  .done(function(datos){
    ...
    $('#consulta tbody').append(
        '<tr>'+
          '<td>'+'<input type="button" name="botonsm" class="botonsm" value="Aceptar" ><input type="button" name="" class="botonsm" value="Rechazar" style="width:50px; height:50px">'+'</td>'+
          '<td>'+datos[i+1]+'</td>'+
          '<td>'+datos[i]+'</td>'+
          '<td>'+'Vista preliminar'+'</td>'+
          '<td>'+datos[i+2]+'</td>'+
        '</tr>');
    }
    });
